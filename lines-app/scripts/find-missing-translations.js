...
function isValidTranslationKey(key) {
  ...
  const skipKeys = ['zod', 'development', 'view', 'date', 'back', 'edit', 'cancel', 'next', 'table', 'newFloorPlan', 'createFloorPlan', 'creating', 'rectangle', 'square', 'lShape', 'custom', 'whatShapeIsYourVenue', 'small', 'medium', 'large', 'howBigIsYourVenue', 'selectApproximateSize', 'addZonesToYourVenue', 'dragZonesToAdd', 'addedZones', 'noZonesYet', 'clickButtonsAbove', 'noSeatingZones', 'goBackToAddZones', 'configureTablesInZones', 'numberOfTables', 'seatsPerTable', 'totalSeats', 'almostDone', 'reviewAndFinish', 'summary', 'zones', 'tables', 'seats', 'floorPlanName', 'linkToLines'];
...
console.log('⚠️  Note: Keys with Hebrew defaultValue in en.json have auto-generated English - please review and update.');
