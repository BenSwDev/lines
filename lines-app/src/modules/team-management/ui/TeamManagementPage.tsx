    ...
    <div className="container max-w-4xl py-8">
      <Card className="border-dashed">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">👥 ניהול צוות ויחצנים</CardTitle>
        </CardHeader>
        <CardContent className="text-center space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <div className="p-4 rounded-lg bg-muted/50">
              ...
              <div className="text-sm text-muted-foreground">ניהול עובדים ותפקידים</div>
            </div>
            <div className="p-4 rounded-lg bg-muted/50">
              <div className="text-2xl mb-2">📣</div>
              <div className="font-medium">יחצנים ומקדמים</div>
              <div className="text-sm text-muted-foreground">מעקב הפניות ואורחים</div>
            </div>
            <div className="p-4 rounded-lg bg-muted/50">
              <div className="text-2xl mb-2">💵</div>
              <div className="font-medium">מעקב עמלות</div>
              <div className="text-sm text-muted-foreground">חישוב אוטומטי</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div className="p-4 rounded-lg bg-muted/50">
              ...
              <div className="text-sm text-muted-foreground">רשימות אורחים ליחצנים</div>
            </div>
            <div className="p-4 rounded-lg bg-muted/50">
              <div className="text-2xl mb-2">📊</div>
              <div className="font-medium">דוחות ביצועים</div>
              <div className="text-sm text-muted-foreground">מעקב תוצאות לאורך זמן</div>
            </div>
          </div>
